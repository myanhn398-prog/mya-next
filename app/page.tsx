        ...
        <div className="relative z-10">
          <nav className="flex items-center justify-between">
            ...
            <div className="hidden md:flex gap-8 text-sm text-slate-300">
              ...
              <a href="#" className="hover:text-cyan-300">Dự án</a>
              <a href="#" className="hover:text-cyan-300">Kỹ năng</a>
          ...
          <div className="grid min-h-[80vh] items-center gap-12 md:grid-cols-2">
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <button className="rounded-2xl border border-white/20 px-7 py-4 font-bold text-white hover:bg-white/10 duration-300">
                  Liên hệ mình
                </button>
              </div>
            </div>
              ...
              <div className="relative rounded-[36px] border border-white/10 bg-white/10 p-8 backdrop-blur-xl shadow-2xl">
                ...
                <div className="mt-8 grid grid-cols-3 gap-4 text-center">
                  <div className="rounded-2xl bg-black/30 p-4">
                    <h4 className="text-2xl font-black text-cyan-300">3+</h4>
                    <p className="text-xs text-slate-400">Kỹ năng</p>
                  </div>

                  <div className="rounded-2xl bg-black/30 p-4">
                    <h4 className="text-2xl font-black text-cyan-300">2</h4>
                    <p className="text-xs text-slate-400">Project</p>
                  </div>

                  <div className="rounded-2xl bg-black/30 p-4">
                    <h4 className="text-2xl font-black text-cyan-300">1</h4>
